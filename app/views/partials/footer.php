                        ...
                        <div class="col-3 col-md-6 col-sm-6">
                            <div class="content">
                                ...
                                <ul class="footer-menu">
                                    <li>
                                        <a href="#">
                                            <img src="https://github.com/trananhtuat/flix-movie-homepage/blob/main/images/google-play.png?raw=true" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="https://github.com/trananhtuat/flix-movie-homepage/blob/main/images/app-store.png?raw=true" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
