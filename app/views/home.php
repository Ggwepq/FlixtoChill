    ...
    <body>
        ...
        <div class="hero-section">
                        ...
                        <div class="hero-slide-item-content">
                            <div class="item-content-wraper">
                                ...
                                <div class="item-action top-down delay-6">
                                    <a href="player.php?type=movie&id=<?= $popular_movie_id ?>" class="btn btn-hover">
            ...
            <div class="top-movies-slide">
                <div class="owl-carousel" id="top-movies-slide">
                    ...
                    <a href="player.php?type=movie&id=<?= $top_movie_id ?>">
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="movies-slide carousel-nav-center owl-carousel">
                    <!-- MOVIE ITEM -->
                    <?php foreach ($nowPlaying as $now):
                        $now_movie_id = $now->getID(); ?>
                    <a href="player.php?type=movie&id=<?= $now_movie_id ?>" class="movie-item">
                        <img src="https:<?= getImageUrl($now_movie_id) ?>" alt="">
                        <div class="movie-item-content">
                            <div class="movie-item-title">
                                <?= $now->getTitle() ?>
                            </div>
                            <div class="movie-infos">
                                <div class="movie-info">
                                    <i class="bx bxs-star"></i>
                                    <span><?= number_format($now->getVoteAverage()) ?></span>
                                </div>
                                <div class="movie-info">
                                    <i class="bx bxs-time"></i>
                                    <span><?= getRuntime($now_movie_id) ?> mins</span>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="movies-slide carousel-nav-center owl-carousel">
                    <!-- MOVIE ITEM -->
                    <?php foreach ($latestShows as $latest):
                        $latest_show_id = $latest->getID(); ?>
                    <a href="player.php?type=tv&id=<?= $latest_show_id ?>" class="movie-item">
                        <img src="https:<?= getImageUrl($latest_show_id, 0, 1) ?>" alt="">
                        <div class="movie-item-content">
                            <div class="movie-item-title">
                                <?= $latest->getName() ?>
                            </div>
                            <div class="movie-infos">
                                <div class="movie-info">
                                    <i class="bx bxs-star"></i>
                                    <span><?= number_format($latest->getVoteAverage()) ?></span>                            
                                </div>
                            </div>
                        </div>
                    </a>
